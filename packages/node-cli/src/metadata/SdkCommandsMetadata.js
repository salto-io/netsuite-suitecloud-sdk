	...
	"account:manageauth": {
		...
		"options": {
			...
			"rename": {
				"name": "rename",
				"option": "rename",
				"description": "Renames an authentication ID (authID). You must specify it together with the renameto option. Usage: manageauth -rename {authID} -renameto {newauthID}.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
			...
			"renameto": {
				"name": "renameto",
				"option": "renameto",
				"description": "Specifies the new ID for an authentication ID (authID). You must specify it together with the rename option. Usage: manageauth -rename {authID} -renameto {newauthID}.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
			...
			"remove": {
				"name": "remove",
				"option": "remove",
				"description": "Removes an authentication ID (authID). Usage: manageauth -remove {authID}.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
