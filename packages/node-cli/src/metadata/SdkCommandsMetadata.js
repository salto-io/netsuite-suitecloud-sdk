module.exports = {
	...
	"project:create": {
		...
		"options": {
			...
			"type": {
				"name": "type",
				"option": "type",
				"description": "Specify the project type. Enter one of the following options: ACCOUNTCUSTOMIZATION or SUITEAPP.",
				"mandatory": true,
				"type": "SINGLE",
	...
	"project:deploy": {
		...
		"options": {
			...
			"applycontentprotection": {
				...
				"description": "Apply the content protection settings from the hiding.xml and locking.xml files. It only applies to SuiteApps. ***This option will be removed in NetSuite 2021.2. Use the \"applyinstallprefs\" option starting from NetSuite 2021.1.***",
				"mandatory": false,
				"type": "FLAG",
				"usage": "",
				"defaultOption": false,
			...
			"applyinstallprefs": {
				...
				"description": "Apply the settings from the hiding.xml, locking.xml, and overwriting.xml files. It only applies to SuiteApps.",
				"mandatory": false,
				"type": "FLAG",
				"usage": "",
				"defaultOption": false,
	...
	"file:import": {
		...
		"options": {
			"paths": {
				"name": "paths",
				"option": "paths",
				"description": "Specify the File Cabinet paths of the files to import. For example, \"/SuiteScripts/file.js\".",
				"mandatory": true,
				"type": "MULTIPLE",
	...
	"account:manageauth": {
		...
		"options": {
			...
			"rename": {
				"name": "rename",
				"option": "rename",
				"description": "Rename an authentication ID (authID). You must specify it together with the renameto option. Usage: manageauth -rename {authID} -renameto {newauthID}.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
			...
			"renameto": {
				"name": "renameto",
				"option": "renameto",
				"description": "Enter the new ID for an authentication ID (authID). You must specify it together with the rename option. Usage: manageauth -rename {authID} -renameto {newauthID}.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
			...
			"revoke": {
				"name": "revoke",
				"option": "revoke",
				"description": "Revokes the TBA token that was issued to your account and is linked to the specified authentication ID (authID).",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
	...
	"project:package": {
		...
		"sdkCommand": "package",
		"usage": "",
		"description": "Generates a ZIP file from your project, respecting the structure specified in the deploy.xml file, and applying local validation.",
		"isSetupRequired": false,
		"options": {
			"destination": {
				"name": "destination",
				"option": "destination",
				"description": "Specify a path to store the ZIP file containing your project.",
				"mandatory": true,
				"type": "SINGLE",
				"usage": "c:/project/",
				"defaultOption": false,
