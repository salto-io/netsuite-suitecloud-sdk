	...
	"account:manageauth": {
		...
		"options": {
			...
			"remove": {
				"name": "remove",
				"option": "remove",
				"description": "Removes an authentication ID. Usage: manageauth -remove {authenticationID}.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
			...
			"revoke": {
				"name": "revoke",
				"option": "revoke",
				"description": "Revokes the TBA token that was issued to your account and is linked to the specified authentication ID.",
				"mandatory": false,
				"type": "SINGLE",
				"usage": "",
				"defaultOption": false,
